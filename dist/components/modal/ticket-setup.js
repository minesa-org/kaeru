import { ActionRowBuilder, bold, ButtonBuilder, ButtonStyle, ContainerBuilder, MediaGalleryBuilder, MediaGalleryItemBuilder, MessageFlags, NewsChannel, PermissionFlagsBits, SeparatorBuilder, SeparatorSpacingSize, TextChannel, TextDisplayBuilder, underline, } from "discord.js";
...
const setupTicketModal = {
    ...
    execute: async (interaction) => {
        ...
        const sendingChannel = SEND_TO_CHANNEL instanceof TextChannel || SEND_TO_CHANNEL instanceof NewsChannel
            ? SEND_TO_CHANNEL
            : null;
        ...
        let imageUrl = "https://cdn.discordapp.com/attachments/736571695170584576/1422748982047932438/Default_Card.png?ex=68ddcdbe&is=68dc7c3e&hm=b16c3ef319ec1633a6798954492a4f3d58114422af50d1e0be9511a459e8ee4f&";
        if (IMAGE_URL) {
        ...
        const container = new ContainerBuilder()
            ...
            .addTextDisplayComponents(new TextDisplayBuilder().setContent(TICKET_MESSAGE ||
            [
                `# ${getEmoji("button")} Create a Ticket`,
                `If you're experiencing an issue with our product or service, please use the "Create ticket" button to report it.`,
                `-# This includes any server-related tickets you may be encountering in our Discord server.`,
        ...
        const containerButton = new ActionRowBuilder().addComponents(new ButtonBuilder()
