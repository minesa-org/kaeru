import { ModalBuilder, TextInputBuilder, TextInputStyle, TextDisplayBuilder, LabelBuilder, } from "discord.js";
const createTicketSelectMenu = {
    ...
    execute: async (interaction) => {
        const modal = new ModalBuilder()
            ...
            .addTextDisplayComponents(new TextDisplayBuilder().setContent("Explain as much as you can with your issue."))
