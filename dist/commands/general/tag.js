import { ApplicationIntegrationType, InteractionContextType, MessageFlags, PermissionFlagsBits, SeparatorBuilder, SlashCommandBuilder, TextDisplayBuilder, } from "discord.js";
    ...
    execute: async (interaction) => {
        ...
        switch (subcommand) {
            ...
            case "delete": {
                ...
                if (found.isServer) {
                    const serverTag = found.tag;
                    if (serverTag.userId !== userId &&
                ...
                return interaction.editReply({
                    components: [
                        containerTemplate({
                            ...
                            thumbnail: "https://media.discordapp.net/attachments/736571695170584576/1413590581686440027/image.png?ex=68bc7c51&is=68bb2ad1&hm=67f01949f10c5eec79e58572edfb8b5c09d914f2185ab52e7a6094aed95051f9&=&width=706&height=706",
                        }),
                    ],
                    flags: MessageFlags.IsComponentsV2,
                });
