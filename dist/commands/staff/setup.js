...
const setup = {
    ...
    execute: async (interaction) => {
        ...
        const ticketCommand = async () => {
            ...
            let imageUrl = "https://cdn.discordapp.com/attachments/736571695170584576/1422748982047932438/Default_Card.png?ex=68ddcdbe&is=68dc7c3e&hm=b16c3ef319ec1633a6798954492a4f3d58114422af50d1e0be9511a459e8ee4f&"; // kaeru's default image for ticket banner
            if (customImageUrl) {
